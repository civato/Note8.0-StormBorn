...
/* 1x mode is for all phone and new tablet dongle(sii9292, sii9296)	*
 * 3x mode is for old tablet dongle(sii9290)				*/
#define MHL_1X_ATTACH	0x11
#define MHL_1X_DETACH	0x10
#define MHL_3X_ATTACH	0x31
#define MHL_3X_DETACH	0x30
