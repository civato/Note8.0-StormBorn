...
static struct gpio_init_data t0_init_gpios[] = {
	...
	{EXYNOS4_GPY0(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* SROMC_CSn */
#else
...
#if defined(CONFIG_LINK_DEVICE_DPRAM)
	{EXYNOS4_GPY0(4), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* SROMC_OEn */
	{EXYNOS4_GPY0(5), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* SROMC_WEn */
#else
	{EXYNOS4_GPY0(4), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV1}, /* NC */
	{EXYNOS4_GPY0(5), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_DOWN, S5P_GPIO_DRVSTR_LV1}, /* NC */
#endif /*CONFIG_LINK_DEVICE_DPRAM*/

#if defined(CONFIG_LINK_DEVICE_DPRAM)
	{EXYNOS4_GPY1(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* SROMC_LBn */
	{EXYNOS4_GPY1(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* SROMC_UBn */
	{EXYNOS4_GPY1(2), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* SROMC_WAITn */
#else
...
static unsigned int t0_sleep_gpio_table[][3] = {
	...
	{EXYNOS4_GPL2(3),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
#endif
#if defined(CONFIG_MACH_T0_GODIVA_LTE) && defined(CONFIG_SEC_MODEM_GODIVA2)
	{EXYNOS4_GPL2(4),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},  /* GPIO_LTE_CP_RESET */
#else
	{EXYNOS4_GPL2(4),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
#endif
#if defined(CONFIG_MACH_T0_EUR_OPEN) || defined(CONFIG_MACH_T0_CHN_CMCC) \
...
#elif defined(CONFIG_MACH_T0_GODIVA_LTE) && defined(CONFIG_SEC_MODEM_GODIVA2)
	{EXYNOS4_GPL2(5),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},  /* GPIO_LTE_PMIC_PWRON */
#else
	{EXYNOS4_GPL2(5),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, /* AP2MDM_PON_RESET_N */
#endif
	{EXYNOS4_GPL2(6),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE}, /* NFC_EN */
	{EXYNOS4_GPL2(7),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NFC_FIRMWARE */
#if defined(CONFIG_LINK_DEVICE_DPRAM)
	{EXYNOS4_GPY0(0),  S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  /* SROMC_CSn */
#else
...
#endif
#if defined(CONFIG_LINK_DEVICE_DPRAM)
	{EXYNOS4_GPY0(4),  S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE}, /* SROMC_OEn */
	{EXYNOS4_GPY0(5),  S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE}, /* SROMC_WEn */
#else
...
#if defined(CONFIG_LINK_DEVICE_DPRAM)
	{EXYNOS4_GPY1(0),  S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  /* SROMC_LBn */
	{EXYNOS4_GPY1(1),  S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},  /* SROMC_UBn */
	{EXYNOS4_GPY1(2),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, /* SROMC_WAITn */
#else
	{EXYNOS4_GPY1(0),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
	{EXYNOS4_GPY1(1),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
	{EXYNOS4_GPY1(2),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
	...
	{EXYNOS4_GPY2(3),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
#elif defined(CONFIG_MACH_T0_GODIVA_LTE) && defined(CONFIG_SEC_MODEM_GODIVA2)
	{EXYNOS4_GPY2(3),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},  /* GPIO_LTE_PS_HOLD_OFF */
#else
...
#if defined(CONFIG_LINK_DEVICE_DPRAM)
	{EXYNOS4_GPY3(0),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(0) */
	{EXYNOS4_GPY3(1),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(1) */
	{EXYNOS4_GPY3(2),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(2) */
	{EXYNOS4_GPY3(3),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(3) */
	{EXYNOS4_GPY3(4),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(4) */
	{EXYNOS4_GPY3(5),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(5) */
	{EXYNOS4_GPY3(6),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(6) */
	{EXYNOS4_GPY3(7),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(7) */

	{EXYNOS4_GPY4(0),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(8) */
	{EXYNOS4_GPY4(1),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(9) */
	{EXYNOS4_GPY4(2),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(10) */
	{EXYNOS4_GPY4(3),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(11) */
	{EXYNOS4_GPY4(4),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(12) */
	{EXYNOS4_GPY4(5),  S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},  /* DPRAM_A(13) */
#else
	...
	{EXYNOS4212_GPJ0(1),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, /*AP_DUMP_INT*/
#elif defined(CONFIG_MACH_T0_GODIVA_LTE) && defined(CONFIG_SEC_MODEM_GODIVA2)
	{EXYNOS4212_GPJ0(1),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},  /* GPIO_AP2LTE_WAKEUP */
#else
...
#ifdef CONFIG_EXYNOS_C2C
	{EXYNOS4212_GPV2(0),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{EXYNOS4212_GPV2(1),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{EXYNOS4212_GPV2(2),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{EXYNOS4212_GPV2(3),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{EXYNOS4212_GPV2(4),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{EXYNOS4212_GPV2(5),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{EXYNOS4212_GPV2(6),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{EXYNOS4212_GPV2(7),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
#else
	{EXYNOS4212_GPV2(0),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
	{EXYNOS4212_GPV2(1),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
	{EXYNOS4212_GPV2(2),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
...
#ifdef CONFIG_EXYNOS_C2C
	{EXYNOS4212_GPV4(0),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{EXYNOS4212_GPV4(1),  S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
#else
	{EXYNOS4212_GPV4(0),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
	{EXYNOS4212_GPV4(1),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
#endif
